...
server.use("/messages", messagesRoute); // Сдвинуть вниз (тест для постмена)
server.use("/test", test); // Сдвинуть вниз (тест для постмена)

server.use("/friends", friendsRoute); // Сдвинуть вниз (тест для постмена)
